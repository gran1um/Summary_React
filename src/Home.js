              ...
              <div class="row">
                <div class="photo-block col-lg-12 col-md-12 col-sm-6">
                  ...
                  <ul class="contacts-block text-center">
                    ...
                    <li>
                      <a href="mailto:vladilena@yandex.ru">mail@yandex.ru</a>
                    </li>
                    <li>
                      <a href="callto:vladilena">Skype: another_user</a>
                    </li>
                  </ul>
                  <div class="address">
                    <p style={{ textAlign: "center" }}>
                      Высоковольтная 34, Москва
                    </p>
                  </div>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                  ...
                  <div class="section">
                    <h2>Образование</h2>
                    <ul>
                      <li>20XX-20XX, Детская школа искусств, гитара</li>
                      <li>20XX-20XX, Гимназия</li>
                      <li>20XX-20XX, МГУ, Экономист</li>
                    </ul>
                  </div>
                </div>
                <div class="col-lg-12">
                  <div class="section">
                    ...
                    <ul>
                      <li>
                        Призер олимпиады по литературе среди 5 классов: 20XX
                      </li>
                      <li>
                        Победитель олимпиады по математике среди 7 классов: 20XX
                      </li>
                      <li>Призер конференции по экономике: 20XX</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <article>
                <header>
                  <h1 class="text-center cv-header mt-5 mb-4">
                    ...
                    <span class="color-grey">Александрова</span>
                  </h1>
                  ...
                  <p class="mb-5">
                    <li>
                      Уверенный пользователь ПК, владею следующими программами:
                      Microsoft Word, Microsoft Excel, Microsoft Power Point,
                      Microsoft Publisher, 1С Бухгалетрия 7 и 8, Клиент-Банк.
                    </li>
                    <li>
                      Опыт работы более трех лет в бухгалтерской сфере, один из
                      которых в бюджетной организации. Обладаю знаниями в
                      области бухгалтерского, налогового учета, финансового
